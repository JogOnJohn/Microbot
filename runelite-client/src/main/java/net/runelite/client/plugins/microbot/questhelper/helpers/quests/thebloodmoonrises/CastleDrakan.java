...
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.CastleDrakanRoomNetwork.RoomKey;
import static net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.CastleDrakanRoomNetwork.door;
...
class CastleDrakan
{
	...
	private void setupGildedAndGibbousKeySteps()
	{
		...
		var ggkpSolveLockboxPuzzle = new ChestCodeStep(quest, "small lockbox", "Γá┐ ß┤ƒ Γüÿ", 10, 2, 3, 7);
