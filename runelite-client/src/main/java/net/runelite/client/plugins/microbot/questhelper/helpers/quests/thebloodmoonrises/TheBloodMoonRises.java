...
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.treesolvers.TreeSolver;
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.treesolvers.TreeSolver1;
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.treesolvers.TreeSolver2;
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.treesolvers.TreeSolver3;
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.treesolvers.TreeSolver4;
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.treesolvers.TreeSolver5;
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.treesolvers.TreeSolver6;
import net.runelite.client.plugins.microbot.questhelper.helpers.quests.thebloodmoonrises.treesolvers.TreeType;
...
import static net.runelite.client.plugins.microbot.questhelper.requirements.util.LogicHelper.nand;
...
public class TheBloodMoonRises extends BasicQuestHelper
{
	...
	private void mapStepsAfterCastleDrakan(Map<Integer, QuestStep> steps)
	{
		...
		// TODO: TEMPORARY UNTIL WE FIGURE OUT REGION + INSTANCE COMBO
		cDoSomething2.addStep(new NpcRequirement(NpcID.MYQ6_LOWERNIEL_COMBAT_3), fightDrakan3);
