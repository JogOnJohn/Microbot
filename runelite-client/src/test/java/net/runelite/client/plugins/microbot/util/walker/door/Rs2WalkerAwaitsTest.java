...
public class Rs2WalkerAwaitsTest {
    ...
    @Test
    public void hasReachedDoorFarSide_rejectsNearAndSideTiles() {
    ...
    @Test
    public void hasReachedDoorFarSide_acceptsDestinationAndBeyond() {
    ...
    @Test
    public void resolvedDoorReadyForFollowup_requiresStableIdleTick() {
